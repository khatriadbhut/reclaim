...
const DATA_CATEGORIES = [
  ...
  },
  {
    ...
    price: 49,
    tagline: "Rollups, time on site, plus IAB vendor categories & IAB Content Taxonomy mapping",
    exportColumns: [
      "top_categories",
  ...
  },
  {
    ...
    price: 45,
    tagline: "Rollup + IAB Content Taxonomy tier-1 segments (merged + split columns)",
    exportColumns: ["audience_segments", "audience_segments_iab", "audience_segments_rollup"],
    description:
      "Pre-computed segments: internal rollups (e.g. high_intent_shopper) plus IAB tier-1 time rules (e.g. iab_travel_core). Exports include merged and split lists for activation pipelines.",
  },
];
